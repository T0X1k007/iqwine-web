...
/** Colonnes du comparatif : Gratuit · Passionné · Premium, l'ordre de la grille. */
...
export default function TarifsContent() {
   ...
   * 100 bouteilles, l'écart de cave avec le Passionné n'est plus que d'un facteur
  ...
  const numericRows: { label: string; hint?: string; cells: string[] }[] = [
    ...
    },
    {
      label: t(
        ...
        "Octave’s personalized advice / mo",
      ),
      hint: t(
    ...
    },
    {
       ...
       * souscrire Passionné et heurter un mur à 200, après avoir importé sa
       * cave.
       */
  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="relative px-6 pb-8 pt-[calc(var(--nav-h)+1.5rem)] text-center sm:pt-[calc(var(--nav-h)+2.5rem)] lg:pb-12">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          {/* ── LA MARQUE DANS LE H1, LA CLARTÉ DANS LE SOUS-TITRE ──────────
              ...
              (inscription gratuite → Passionné 14 jours → puis le choix) sans
          ...
          <div className="mt-6 flex justify-center sm:mt-7">
            <a
               ...
               * 14 jours de Passionné que par le parcours par défaut. Un
              ...
              onClick={() =>
                track(ANALYTICS_EVENTS.SIGNUP_CLICK, { source: "tarifs-hero" })
              }
            >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, var(--color-background) 0%, #2a1d13 26%, var(--color-papier-2) 72%, var(--color-papier) 100%)",
        }}
      />
      <Pricing ton="jour" />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, var(--color-papier) 0%, var(--color-papier-2) 24%, #2a1d13 74%, var(--color-background) 100%)",
        }}
      />
      <section className="px-6 pb-16 lg:pb-24">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-3 text-center text-[12px] tracking-wide text-foreground-faint sm:hidden">
            {t(
              "Faites glisser le tableau pour comparer",
          ...
          <FadeInOnScroll delay={0.16}>
            <div className="mt-10 text-center">
              <a
                ...
                onClick={() =>
                  track(ANALYTICS_EVENTS.SIGNUP_CLICK, {
                    source: "tarifs-comparatif",
                  })
                }
              >
                <Button variant="cta" size="lg">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, var(--color-background) 0%, #2a1d13 8%, var(--color-papier-2) 36%, var(--color-papier) 100%)",
        }}
      >
              ...
              <FadeInOnScroll key={i} delay={Math.min(i * 0.06, 0.24)}>
                <div className="h-full rounded-xl border border-encre/10 bg-[#fdfaf3]/70 p-5">
                  <Icon
                    size={20}
                    strokeWidth={1.6}
                    className="mb-3 text-or-jour"
                    aria-hidden
                  />
                  <h3 className="font-[family-name:var(--font-display)] text-[17px] italic text-encre">
                    {title}
                  </h3>
          ...
          <div className="mx-auto flex max-w-4xl flex-col items-center justify-between gap-5 rounded-2xl border border-or-jour/25 bg-[#fdfaf3]/70 p-7 text-center sm:flex-row sm:p-8 sm:text-left">
            ...
            <LocaleLink href="/sommelier-ia" className="shrink-0">
              <Button
                variant="secondary"
                size="lg"
                className="!border-encre/25 !bg-transparent !text-encre hover:!bg-encre/5 hover:!border-encre/35"
              >
      ...
      <section className="mouvement-jour relative px-6 pb-14 lg:pb-16">
        <FadeInOnScroll>
          <p className="mx-auto max-w-[56ch] text-center text-[15.5px] leading-relaxed text-encre-2 md:text-[16.5px]">
            ...
            <LocaleLink
              href="/fonctions"
              className="text-bordeaux-jour underline underline-offset-4 hover:text-or-jour"
            >
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, #150f0c 0%, #2a1d13 7%, var(--color-papier-2) 30%, var(--color-papier) 100%)",
        }}
      >
        <FadeInOnScroll>
          <h2
          ...
          <div className="mt-8 flex justify-center">
            <a
              ...
              onClick={() =>
                track(ANALYTICS_EVENTS.SIGNUP_CLICK, { source: "tarifs-final" })
              }
            >
