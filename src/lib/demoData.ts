...
const DATA: Record<DemoMeal, MealData> = {
  ...
  boeuf: {
    ...
    cave: {
      ...
      window: {
        fr: 'Il est à son apogée : ses tanins se sont fondus, à ouvrir ce soir sans tarder.',
        en: 'It’s at its peak: its tannins have softened, open it tonight without delay.',
      },
      windowFrom: 2022,
      windowPeak: 2027,
      windowTo: 2035,
