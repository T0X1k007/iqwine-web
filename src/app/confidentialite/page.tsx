 ...
 * responsable, collecte, finalités, conservation, communication hors Québec,
 * données de tiers, droits. À garder synchrone avec cellier-vin.
 */
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-24 text-muted-foreground">
      ...
      <p className="font-mono text-[11px] tracking-[0.18em] uppercase text-foreground-faint mb-12">
        En vigueur le {LEGAL_EFFECTIVE_DATE} · Conforme à la Loi 25 (Québec)
      </p>

      <Section title="Responsable de la protection des renseignements">
      ...
      <Section title="Consentement et retrait">
      ...
      <Section title="Communication à des tiers et hors Québec">
      ...
      <Section title="Données de tiers (SAQ et autres sources)">
      ...
      <Section title="Vos droits (Loi 25)">
