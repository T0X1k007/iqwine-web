...
const PAGES: Array<{ path: string; priority: number; freq: Freq }> = [
  ...
  // Hub Fonctions (architecture 2026-08-13). Les futures pages Fonction
  // s'ajouteront ICI une à une, à leur naissance, jamais avant.
  { path: '/fonctions', priority: 0.9, freq: 'monthly' },
  { path: '/cellier-intelligent', priority: 0.9, freq: 'monthly' },
  { path: '/sommelier-ia', priority: 0.9, freq: 'monthly' },
  { path: '/le-film', priority: 0.8, freq: 'monthly' },
  { path: '/apogee', priority: 0.8, freq: 'monthly' },
  // /recherche absorbée par /choisir-un-vin (301, 2026-08-14) — la page
  // Fonction hérite de la place du pilier, avec le poids d'une page Fonction.
  { path: '/choisir-un-vin', priority: 0.9, freq: 'monthly' },
  // /recevoir absorbée par /accord-mets-vins (301, 2026-08-13).
  { path: '/accord-mets-vins', priority: 0.9, freq: 'monthly' },
  { path: '/carte-des-vins', priority: 0.9, freq: 'monthly' },
